...
export default function Sidebar() {
  ...
  return (
    <aside>
      ...
      <div
        className="dndnode four-handles"
        onDragStart={(event) => onDragStart(event, "four-handles")}
        draggable
      >
        Four Handles Node
      </div>
      ...
      <div
        className="dndnode input resizable-node"
        onDragStart={(event) => onDragStart(event, "resizable-node")}
        draggable
      >
        Resizable Node
      </div>
